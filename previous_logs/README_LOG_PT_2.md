# 100 Days of Code Log - Part 2 ... Another 90 Days !!! 💯 🤛
...
**Inspiration** Wanted to do another 100 Days. You can see my previous log [here](previous_logs/README_LOG_PT_1.md).
...
### Day 2: 02 Aug. Wednesday

**Today's Progress**: 

- Continued Working on Section 7 of [React-Native-and-Redux](https://www.udemy.com/the-complete-react-native-and-redux-course/learn/v4/t/lecture/5738524?start=0) Udemy Course.

- Continued working on pvt React Native app, cleaning the `<Input />` components on the `<Signup />` view component and added a `<Button />` component.

**Not Code:** Started chapter 3 of **"Javascript the Good parts"** and continued chapter 3 of **"The Pragmatic Programmer"**

**Thoughts:** Need to find a way to clean my stylesheets for the react native app.

**Link to work:** *See Today's progress*

<hr />

### Day 3-24: 03 Aug. Thursday - 24 Aug. Thursday  **21 DAYS**
...
- Finished working on Chapter 4 of **JS the Good parts: Functions** Did:
  - [x] Return. Created a snippet of what I have learnt in chrome. Here is [jsfiddle](https://jsfiddle.net/intercoder/zcs03rpj/25/)
...
- Finished Section 6 of [learn-svg-animation](https://www.udemy.com/learn-svg-animation) Udemy Course.
  - [x] gradient instagram icon. [Codepen](https://codepen.io/intercoder/pen/f7a26e58b4a667db494bebccb35ba37c?editors=1100)
...
- Finished section 15 and started Section 16 of [React-Native-and-Redux](https://www.udemy.com/the-complete-react-native-and-redux-course/learn/v4/t/lecture/5738524.1?start=0) Udemy Course.
  - [x] Connected the `emailChanged` and `passwordChanged` action creators to the `<LoginForm />` container. Experimenting with `flow` on my reducers.
...
- Continue working on Section 16 of [React-Native-and-Redux](https://www.udemy.com/the-complete-react-native-and-redux-course/learn/v4/t/lecture/5738524.1?start=0) Udemy Course.
 - [x] Add an `<Spinner />` component to the `<LoginForm />` container and an action to the reducer.
